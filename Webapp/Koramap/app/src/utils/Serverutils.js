...
function add_media(userId, filename, file, callback) {
	const formData="GUID=" + userId + "&filename=" + filename + "&file=" + file;
	
	var request = new XMLHttpRequest;
	
	var method = 'POST';
	var url = 'http://ecocollector.azurewebsites.net/add_media.php';
