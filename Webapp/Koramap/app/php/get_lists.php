...
if (isset($_POST['GUID']))
{
    ...
    if (!empty($result))
    {
        ...
        {
            // Username not found
            $response["institutions"] = "Warning: institutions not found";	
        }
    }
    else
    {
    ...
    if (!empty($result_tags))
    {
        ...
        {
            // Username not found
            $response["tags"] = ["Warning: tags not found"];	
        }
    }
    else
    {
    ...
    if (!empty($result_spec))
    {
        ...
        {
            // Username not found
            $response["species"] = ["Warning: species not found"];	
        }
    }
    else
    {
    ...
    if (!empty($result_unit))
    {
        ...
        {
            // Username not found
            $response["units"] = ["Warning: units not found"];	
        }
    }
    else
    {
